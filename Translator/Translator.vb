...
#Region "Constructor"
        ...
        Shared Sub New()
            ...
            _path = Config.GetSubFolder(Config.Dir.Language, "myTvNiveauChecker")
...
#Region "Public Methods"
        ...
        Public Shared Sub TranslateSkin()
            MyLog.Debug("Translating skin")
            For Each name As String In Strings.Keys
                SetProperty("#myTvNiveauChecker.Translation." & name, Translator.Strings(name))
            Next
        End Sub
