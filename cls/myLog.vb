...
Public Class MyLog
    ...
    ''' </summary>
    Private Shared ReadOnly _logDaysToKeep As New TimeSpan(5, 0, 0, 0)

    ''' <summary>
    ''' The maximum size of each log file in Megabytes
    ''' </summary>
    Private Const _maxLogSizeMb As Integer = 200
    ...
    Private Shared Function GetFileName(ByVal logType__1 As LogType) As String
        ...
        Select Case logType__1
            Case LogType.Debug, LogType.Info
                Return [String].Format("{0}\log\{1}", GetPathName, GetLogFileName)
